...
@section('title', 'Cadastrar Novo Garçom')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Cadastrar Novo Garçom</h2>
            <p class="text-gray-600 dark:text-gray-400 mt-1">Preencha os dados abaixo para criar uma nova conta de garçom</p>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    @error('senha')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">A senha deve ter no mínimo 6 caracteres</p>
                </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700 dark:text-blue-200">
                                <strong>Permissões Padrão:</strong> Por padrão, o garçom poderá lançar pedidos e fechar mesas, mas NÃO poderá cancelar itens ou pedidos. Você pode ajustar essas permissões após o cadastro.
                            </p>
                        </div>
                    </div>
                </div>
