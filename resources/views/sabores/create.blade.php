            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="preco_p" id="preco_p" value="{{ old('preco_p') }}" step="0.01" min="0" class="w-full pl-10 pr-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition" placeholder="0,00">
                    </div>
                    @error('preco_p')
                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">R$</span>
                        <input type="number" name="preco_m" id="preco_m" value="{{ old('preco_m') }}" step="0.01" min="0" class="w-full pl-10 pr-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition" placeholder="0,00">
                    </div>
                    @error('preco_m')
                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">R$</span>
                        <input type="number" name="preco_g" id="preco_g" value="{{ old('preco_g') }}" step="0.01" min="0" class="w-full pl-10 pr-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition" placeholder="0,00">
                    </div>
                    @error('preco_g')
                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">R$</span>
                        <input type="number" name="preco_gg" id="preco_gg" value="{{ old('preco_gg') }}" step="0.01" min="0" class="w-full pl-10 pr-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition" placeholder="0,00">
                    </div>
                    @error('preco_gg')
                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                    @enderror
